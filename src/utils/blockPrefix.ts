...
// excluding (unless includeCodeLines is true) code lines and (only for multi-line
// selections) blank lines so a single empty line can still be turned into a list/quote.
